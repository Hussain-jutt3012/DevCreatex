...
const technologies = [
  ...
  { name: "Three.js", icon: "simple-icons:threedotjs", color: "#000000" },
  ...
  return (
    <section className="relative w-full overflow-hidden py-14 sm:py-16 lg:py-20">
      ...
      <div className="container mx-auto mb-10 px-5 sm:px-6 lg:px-8">
        <div className="mx-auto flex w-full max-w-4xl flex-col items-center text-center">
          ...
          <motion.h2
            ...
            className="
              section-title mx-auto mt-4 w-full max-w-3xl text-center
            "
          >
          ...
          <motion.p
            ...
            className="
              muted mx-auto mt-4 w-full max-w-2xl text-center
      ...
      <div className="relative w-full overflow-hidden py-5">
        ...
        <div
          className="
            pointer-events-none absolute left-0 top-0 z-20 h-full w-12
            bg-gradient-to-r from-white via-white/90 to-transparent
            dark:from-[#070b16] dark:via-[#070b16]/90 dark:to-transparent
            sm:w-20 md:w-32 lg:w-40
          "
        />
        ...
        <div
          className="
            pointer-events-none absolute right-0 top-0 z-20 h-full w-12
        ...
        <motion.div
          className="
            flex w-max items-center gap-8 px-6
            sm:gap-10 sm:px-8 md:gap-12 lg:gap-14
          "
          animate={{
            x: ["0%", "-50%"],
          }}
        ...
        >
          {marqueeItems.map(({ name, icon, color }, index) => (
            <motion.div
              key={`${name}-${index}`}
              className="
                group flex w-[76px] shrink-0 cursor-pointer
                flex-col items-center justify-center
                overflow-visible py-3 sm:w-24
              "
              whileHover={{
                y: -6,
                scale: 1.08,
            ...
            >
              ...
              <motion.div
                ...
                transition={{
                  ...
                  ease: "easeInOut",
                  delay:
                    (index % technologies.length) * 0.08,
                }}
                className="
                  relative flex h-12 w-12 shrink-0
                  items-center justify-center
                  overflow-visible sm:h-14 sm:w-14
                "
              >
                {/* Soft Glow */}
                <span
              ...
              <span
                className="
                  mt-3 whitespace-nowrap text-center
